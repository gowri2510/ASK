...
# Output Waveform
``
<img width="1190" height="790" alt="image" src="https://github.com/user-attachments/assets/d2c19712-852f-4fbc-b0c0-75d8520884b4" />
```
```
#FSK
``
...
```
#OUTPUT
<img width="1201" height="1012" alt="image" src="https://github.com/user-attachments/assets/292e1709-3586-47af-baa7-a4a760166ac1" />

#RESULT:
Thus,the program for the modulation and demodulation of ASK and FSK is verified.
